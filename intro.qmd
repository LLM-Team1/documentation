...
In this course our goal was to build a LLM application. Therefore we created a use case and build a business model canvas and identified a business unit that could be improved through such a LLM application. 
